...
## 0.6.0 - First fork release

This is an independent fork of the original Dart Data Class Generator by bxqm, following the huang12zheng fork. The original MIT attribution and historical release notes remain below.
